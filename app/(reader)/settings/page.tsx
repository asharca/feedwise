...
import { ArrowLeft, Sun, Moon, Monitor, Upload, Download, Trash2, Pencil } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <Card className="rounded-2xl border-border/50">
          <CardHeader>
            ...
            <CardDescription>Connect AI assistants to your RSS data</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-3">
              Feedwise includes an MCP server that lets Claude and other AI assistants
              query your subscriptions and articles.
            </p>
